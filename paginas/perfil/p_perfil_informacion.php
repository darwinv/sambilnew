		...
		<div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
			...
			<div class="perfil-info-menu  mar-perfil-informacion">
				<div class="act" data-href="#informacion">
					<i class="fa fa-share"></i> Informac&oacute;n Personal
				</div>
				<br>
				<div data-href="#redes">
					<i class="fa fa-share"></i> Informac&oacute;n Social
				</div>
				<br>
		...
		<div class="col-xs-12 col-sm-12 col-md-9 col-lg-9">
			<section id="informacion" class="borde-left-informacion sec-informacion">
				<div class="contenedor sombra-div mar10 mar-perfil-informacion"
					style="padding: 10px;">
					<b class="marR5">Tel&eacute;fono:</b> <?php echo $usuario->u_telefono;?>
				</div>
				<div class="contenedor sombra-div mar10 mar-perfil-informacion"
					style="padding: 10px;">
				...
				<div class="contenedor sombra-div mar10 mar-perfil-informacion"
					style="padding: 10px;">
					<b class="marR5">Direcci&oacute;n Fiscal:</b> <?php echo $usuario->u_direccion;?>
					
				</div>
				<div class="contenedor sombra-div mar10 mar-perfil-informacion"
					style="padding: 10px;">
					<b class="marR5">RIF:</b> <?php echo $usuario->j_tipo.'-'. $usuario->j_rif;?>
				</div>
			</section>
			<?php if(isset($edit)):?>
			...
			<section id="redes" class="borde-left-informacion sec-informacion">
				<div class="contenedor sombra-div mar10 mar-perfil-informacion "
					style="padding: 10px;">
					<b class="marR5">Acerca de:</b> <?php echo is_null($usuario->u_descripcion)?"<span class='opacity'>Sin informaci&oacute;n</span>":$usuario->u_descripcion;?>
				</div>
				<div class="contenedor sombra-div mar10 mar-perfil-informacion "
					style="padding: 10px;">
					<b class="marR5">Sitio Web: </b> <?php echo is_null($usuario->u_website)?"<span class='opacity'>Sin informaci&oacute;n</span>":$usuario->u_website;?>
				</div>
				<div class="contenedor sombra-div mar10 mar-perfil-informacion "
					style="padding: 10px;">
					<b class="marR5">Facebook: </b> <?php echo is_null($usuario->u_facebook)?"<span class='opacity'>Sin informaci&oacute;n</span>":$usuario->u_facebook;?>
				</div>
				<div class="contenedor sombra-div mar10 mar-perfil-informacion "
					style="padding: 10px;">
