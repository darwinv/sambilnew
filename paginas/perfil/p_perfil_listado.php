				...
				<div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 text-right">
					...
					<span class="input-group-btn">
						...
						<select class="form-control input" id="filter" name="filter">
							<option >M&aacute;s Recientes</option>
		...
		<div class="row " id="publicaciones" name="publicaciones">
								    ...
								    <div class=' col-xs-12 col-sm-12 col-md-3 col-lg-3 text-right'>
								    	...
								    	<div class='marR20'>
											...
											<span class=' t12'></span>
											<br>
											<span class='vin-blue t16'><a href='detalle.php?id=" . $valor["id"] . "' style='text-decoration:underline;'>Ver M&aacute;s</a></span >
										</div>
									</div>
