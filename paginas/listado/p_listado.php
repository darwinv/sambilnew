...
$ultimo=$pagina * 25;
?>
	<div class="container marT40 " id="principal" name="principal"  data-cla="<?php echo $act_cla;?>" data-est="<?php echo $act_est;?>" data-con="<?php echo $condicion;?>" 
			...
			<div class="col-xs-12 col-sm-12 col-md-2 col-lg-2 resultados" > <!-- ocultar cuando no hay resultados -->
				<div class="marL5 marT5 marB5  contenedor">
					<div class="marL10">
						<div id="categorias">
							<br>
							<h5 class="negro"><b>Categor&iacute;as</b></h5>
						<hr class="marR5"></div>
...
<!--							<li class="marB10 t11"><div  class="h-gris"><span ><a class="grisO" href="listado.php">Táchira<b class="grisO">(19)</b></a></span></div></li>
						...
						<?php
						    if($ac>0){
								...
								foreach ($publicaciones as $h["publicaciones"] => $valor):
									...
									<br><span class=' t12'></span><br><span class='vin-blue t16'><a href='detalle.php?id=<?php echo $valor["id"];?>' style='text-decoration:underline;'>Ver M&aacute;s</a></span >
						...
						?>
						<div class="marT40"><?php include "temas/footer.php"?></div>
						</div>
