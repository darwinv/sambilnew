...
if(isset($_GET["palabra"]) || isset($_GET["tiendas"])){
	$lista=array();
	$c=0;
									...
									<ul class="nav marR5 t11  marT10 marB20 ">
										<?php
											foreach($estados as $e=>$valor):
												if($valor["totaP"]>0):
											?>
													<li class='marB10 t11'><div  class='h-gris'><span ><a class='blue-vin filtroest' href='#' data-id="<?php echo $valor["id"];?>"><?php echo "{$valor["nombre"]} ({$valor["totaP"]})";?></a></div></span></li>
													<?php
												endif;
											endforeach;
											?>
											...
											?>
											    ...
											    <div class=' col-xs-12 col-sm-12 col-md-3 col-lg-3 text-right'>
											    	<div class='marR20'><span class='red t20'><b> <?php echo $publi->getMonto();?></b></span >
														 <br><br><span class='vin-blue t16'><a href='detalle.php?id=<?php echo $publi->id;?>' style='text-decoration:underline;'>Ver Mas</a></span >
													</div>
												</div>
