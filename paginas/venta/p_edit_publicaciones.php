		...
		<div class="row" style="margin-left: 40px; margin-right: 40px;">
			<form id="pub-form-reg" name="pub-form-reg" action"ventas.php" method="get">
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 ">
					...
					<span class="">Actualización de la publicacion <span class="opacity grisO t16"># <?php if(isset($publi)){ echo $publi->id;}?></span></span>
				...
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					<div class=""  style="width: 100%; ">
						...
						<div id="editor" name="editor"><?php echo utf8_decode(utf8_decode($_POST["descripcion"])); ?></div>					
					</div>
				</div>
