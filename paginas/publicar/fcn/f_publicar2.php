		...
		<div class="row" style="margin-left: 80px; margin-right: 80px;">
			<form id="pub-form-reg" name="pub-form-reg" action="paginas/publicar/fcn/f_publicaciones" method="POST">
				...
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 marT20">
					<div class="t16">
						...
						style="width: 80%; margin: 0px; padding: 2px; font-size: 11px;">
							<span class="marL5"><i class="fa fa-info-circle marR5"></i> <b>Recomendaci&oacute;n: </b>Procura que la imagen sea de buena calidad y obtendr&aacute;s mejores
				...
				<div id="alertafoto" class="col-xs-12 col-sm-12 col-md-12 col-lg-12 marT10 hidden">
					...
					style="width: 80%; margin: 0px; padding: 2px; font-size: 11px;">
						<span class="marL5"><i class="fa fa-warning marR5"></i> Debes subir al menos una (01) imagen para tu publicaci&oacute;n.</span>
					</div>
				</div>
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 marT20">
					<div class="t16">
						<b>Col&oacute;cale un video a tu publicaci&oacute;n (opcional)</b>
					</div>
				</div>
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-6 marT10 marB10 ">
					<div class="form-group input-group" style="width: 100%; ">
						<input data-fv-field="website" type="text" placeholder="Pega la Url del Video aca" name="url_video" id="url_video" class=" form-control " id="">
					</div>				
				</div>
				...
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-6 marT10 marB10 ">
					<div class="form-group input-group" style="width: 100%; ">
						<input type="text" placeholder="T&iacute;tulo de la publicaci&oacute;n" name="txtTitulo" id="txtTitulo" class=" form-control " id="">
					</div>				
				</div>
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-6 marT10  marB10 ">
				...
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 marT20 marB10">
					<div class="t16">
						<b>M&iacute;s especificaciones</b>
					</div>
				</div>
						...
						<table>
							<tr>
								...
								<select class="form-select " style="margin-top:20px;display:none;" id="cmbGarantia" name="cmbGarantia">
									...
									<option value="15 dias de ">15 D&iacute;as</option>
