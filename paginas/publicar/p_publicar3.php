						...
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" >
							<form id="pub-form-date" method="POST" name="pub-form-date">
								<div style="margin:40px; margin-left: 200px; margin-right: 200px; ">
									<i class="fa fa-check-circle green marL10"></i> Tu publicaci&oacute;n sera
									iniciada
									...
									style="width: 100%; margin: 0px;  margin-bottom:5px; padding: 5px; font-size: 12px; ">
										<span class="marL5"><i class="fa fa-info-circle marR5"></i> <b>Informacion: </b> Tu publicaci&oacute;n es totalmente gratis y estara en nuestros listados durante 30 dias...</span>
									</div>
									<!-- <p class="t12 orange-apdp marL10 "> ¡Compra y vende lo que quieras! </p> -->
