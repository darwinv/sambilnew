...
border-bottom-left-radius: 10px;" >
    ...
    <!--<div class="col-xs-12 col-sm-12 col-md-6 col-lg-2">
      <p class="text-left mar20 " style="border-right: 1px solid #ccc;">
        <span class="negro t26 ">Ultimas <br> p�blicaciones</span>
        <br><br>
        <span class="">echale un vistazo a las publicaciones m�s recientes.</span>
        <br><br> 
...
<!-- 5 mas visitadas --------------------------------------------------------------------------------------------------------------- -->
   ...
   <div  class="anchoC  center-block hidden">
    ...
    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-2">
      <p class="text-left mar20" style="border-right: 1px solid #ccc;">
        <span class="negro t26 ">Top 5 <br> M�s Visitados</span>
        <br><br>
        <span>Echale un vistazo a las publicaciones m�s populares.</span>
        <br><br>
...
<div class="hidden-xs hidden-sm col-md-1 col-lg-1">
 ...
 <!--   <div class="col-xs-12 col-sm-12 col-md-6 col-lg-2">
      <p class="text-left mar20" style="border-right: 1px solid #ccc;">
        ...
        <br><br>
        <span>Echale un vistazo a los vendedores m�s destacados.</span>
        <br><br>
        <span class="vin-blue t18" style="text-decoration:underline; visibility: hidden;"><a href="#">Ver m�s...</a></span>
        <br>
        <br>
        <br>
