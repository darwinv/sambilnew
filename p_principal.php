...
<span class="marL10" >Publicaciones mas recientes</span>
</div>
</div>
</div>
...
border-bottom-left-radius: 10px;" >
    ...
    <!--<div class="col-xs-12 col-sm-12 col-md-6 col-lg-2">
      <p class="text-left mar20 " style="border-right: 1px solid #ccc;">
        <span class="negro t26 ">Ultimas <br> p&oacute;blicaciones</span>
        <br><br>
        <span class="">echale un vistazo a las publicaciones m&oacute;s recientes.</span>
        <br><br> 
        <span class="vin-blue t18 " style="text-decoration:underline;"><a href="listado.php">Ver m&oacute;s...</a></span>
         <br>
        <br>
        <br>
        <br>
...
<div class="hidden-xs hidden-sm col-md-1 col-lg-1">
 ...
 <!--   <div class="col-xs-12 col-sm-12 col-md-6 col-lg-2">
      <p class="text-left mar20" style="border-right: 1px solid #ccc;">
        ...
        <br><br>
        <span>Echale un vistazo a los vendedores m&oacute;s destacados.</span>
        <br><br>
        <span class="vin-blue t18" style="text-decoration:underline; visibility: hidden;"><a href="#">Ver m&oacute;s...</a></span>
        <br>
        <br>
        <br>
...
//	$result=$bd->query("select count(*) as tota,usuarios_id from publicaciones where id in (select publicaciones_id from publicacionesxstatus where status_publicaciones_id=1 and fecha_fin IS NULL) group by usuarios_id order by tota desc limit 5");
   ...
   <div class='col-xs-12 col-sm-12 col-md-6 col-lg-2'>
	    		<a href="#">	<div class='text-center mar10 ' style='relative;width:70%;'>
				    	<br>
				    	<div class='marco-foto-conf  point center-block sombra-div3 ' style='height:120px; width: 120px;'  >
		...
		<div class='col-xs-12 col-sm-12 col-md-6 col-lg-2'>
	    		<a href="perfil.php?id=850"> <div class='text-center mar10 vendedores' style='relative;width:70%;' >
				    	<br>
				    	<div class='marco-foto-conf  point center-block sombra-div3 ' style='height:120px; width: 120px;'  >					
