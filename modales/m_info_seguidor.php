<div class="modal fade bs-example-modal-lg modal-conf" data-type=""  tabindex="-1" role="dialog"
				...
				<div class="modal-body">
                    ...
                    <div class=" marL30 row">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-5 col-lg-5">
                            <div class="marco-foto-conf" style="width:150px; height:150px;"<a href="#" ><img id="fotoperfil" width="100%" height="100%;" class="img img-responsive"  ></a></div>
                        </div>

                        <div class="col-xs-12 col-sm-12 col-md-7 col-lg-7 text-left " style="margin-left:-5px;">
                        <br>
                            <span id="index" class="t18"> </span> 
                            <br>
                            <span id="seudonimo" class="t16"> </span>
                            <br>
                            <span id="nombres" class="t14"> </span>
                            <br>
                            <span id="telefono" class="t14"> </span>
                            <br>
						    <span id="correo" class="t14"> </span>
