$(document).ready(function(){
	...
	$("#dia").click(function(){
   	...
   	$("#dias").css({ opacity: .9,
           ...
           backgroundColor: "grey" //rgba(192,192,192,.9)
      });
	});
...
var input1 = $('#t1').pickadate({editable: true, container: '#date-picker',  monthsFull: ['Enero', 'Febrero', 'Marzo', 'Abril', 'Mayo', 'Junio', 'Julio', 'Agosto', 'Septiembre', 'Octubre', 'Noviembre', 'Diciembre'],
